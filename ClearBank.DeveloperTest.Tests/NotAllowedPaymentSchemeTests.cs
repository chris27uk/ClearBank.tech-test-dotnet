...
namespace ClearBank.DeveloperTest.Tests
{
    public class NotAllowedPaymentSchemeTests
    {
        ...
        {
            var context = PaymentTestSubject.WithExpectedResponse(accountsInPrimaryDataStore: [ PaymentTestSubject.CreateAccount(allowedPaymentSchemes: allowedPaymentSchemes) ]);
